...
class ActionEdgeGraphRelationCapturer(nn.Module):
    ...
    def __init__(
        ...
        self.action_embedding = nn.Embedding(n_actions, relation_dim)
    ...
    def _init_rpg_relation_capturer(self):
        ...
        if capturer_cls is PublicRPGRelationCapturer:
            ...
            capturer_kwargs.update(
                ...
                return_target_context=self.model_type == "rpg_action_edge_target_context_hypercond",
        ...
        if self.model_type == "qmix_minimal":
            ...
            if self.model_type in {"local_structured_hypercond", "local_linear_interaction_hypercond"}:
                ...
                if self.model_type == "rpg_action_edge_coarse_private_fine_gate_hypercond":
                    ...
                    if self.model_type == "rpg_action_edge_target_context_hypercond":
