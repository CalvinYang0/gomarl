...
class GroupAgent(nn.Module):
    def __init__(self, input_shape, args):
        ...
        self.use_graph_head = getattr(args, "group_update_mode", "contribution") == "graph"
    ...
    def forward(self, inputs, hidden_state):
        ...
        if self.use_graph_head:
            ...
            graph_scores = h.new_zeros((b * a, self.args.n_agents))
            graph_context = h.new_zeros((b * a, self.a_h_dim))
        ...
        return q.view(b, a, -1), h.view(b, a, -1), group_state.view(b, a, -1), graph_scores.view(b, a, -1)
