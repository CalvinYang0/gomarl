...
1. Start with `01_chatgpt_context.md` when asking ChatGPT to draft or polish text.
2. Use `02_method_and_code_inventory.md` when the writing needs exact model details.
3. Use `03_experiment_plan.md` when planning runs, ablations, or result analysis.
4. Use `04_visualization_plan.md` when explaining relation-pattern/head-parameter visualization.
5. Use `05_writing_prompts.md` as reusable prompts.
6. Use `06_run_command_templates.md` when launching the current main experiments.
7. Use `07_ai_writing_workflow.md` to coordinate Codex, ChatGPT, and human revision.
