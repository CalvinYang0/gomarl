...
export MODELS="${MODELS:-rpg_action_edge_public_pred_public_hyper_private_input_single_head rpg_action_edge_public_pred_private_hyper_public_input_single_head rpg_action_edge_public_pred_coarse_fine_four_layer_head rpg_action_edge_public_pred_coarse_q_fine_gate_head rpg_action_edge_egcn_plus_public_pred_hypercond}"
