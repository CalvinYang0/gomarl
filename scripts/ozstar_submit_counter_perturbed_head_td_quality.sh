...
# Old joint-training framework control: all parameters receive the ordinary TD
# loss every update, while only the observation-conditioned gate receives the
# additional perturbed-head TD-quality loss.
...
job_name="grf_counter_perturbed_head_td_quality_s${SEED}"
run_name="grf_counter_perturbed_head_td_quality_10m_s${SEED}"
model_type="grf_abs_dual_branch_binary_concrete_perturbed_head_td_quality_hypercond"
