...
SEEDS="${SEEDS:-1}"
MODELS="${MODELS:-rpg_public_private_bias_transformer_hypercond rpg_public_private_bias_transformer_topk_hypercond rpg_public_private_bias_transformer_threshold_hypercond}"
GROUP_NAME="${GROUP_NAME:-3s5z_private_bias_transformer_48h_s1}"
...
echo "== Submit 3s5z private-bias Transformer 48h runs =="
echo "repo: $REPO_DIR"
echo "map: $MAP_NAME"
echo "models: $MODELS"
echo "seeds: $SEEDS"
