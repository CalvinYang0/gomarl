...
# Four Counter ablations on the same temporal + mask/parameter-relation base:
#   1) permutation-invariant grouped gate input/output,
#   2) permutation-invariant grouped mask distance only,
#   3) stop gradient through generated-parameter distance (explicit baseline),
#   4) stop gradient through mask distance (reverse relation direction).
...
TEMPORAL_COEF="${TEMPORAL_COEF:-50.0}"
...
declare -a specs=(
  "temporal_relation_group_gate|grf_abs_dual_branch_binary_concrete_temporal_relation_group_gate_hypercond"
  "temporal_relation_group_distance|grf_abs_dual_branch_binary_concrete_temporal_relation_group_distance_hypercond"
  "temporal_relation_stop_param|grf_abs_dual_branch_binary_concrete_temporal_relation_stop_param_hypercond"
  "temporal_relation_stop_mask|grf_abs_dual_branch_binary_concrete_temporal_relation_stop_mask_hypercond"
)
