...
# Counter comparison for decoupled importance training:
#   80k environment steps: non-gate parameters, TD only
#   20k environment steps: gate parameters, TD + importance auxiliary
...
NON_GATE_PHASE_STEPS="${NON_GATE_PHASE_STEPS:-80000}"
GATE_PHASE_STEPS="${GATE_PHASE_STEPS:-20000}"
ALTERNATING_START_STEPS="${ALTERNATING_START_STEPS:-0}"
