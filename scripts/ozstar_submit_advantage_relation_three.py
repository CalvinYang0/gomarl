#!/usr/bin/env python3
"""Preflight and append Advantage-grouped KL80 runs on three scenes."""
import json
import os
...
def main():
    ...
    os.chdir(repo)
    subprocess.run(
        [sys.executable, "scripts/smoke_test_advantage_relation.py"], check=True
    )
    ...
    manifest = logdir / "advantage_relation_three_{}_{}.json".format(
