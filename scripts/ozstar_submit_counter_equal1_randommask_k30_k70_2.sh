...
# Extend the current equal1 + episode-random + multiplicative random-mask
# experiment with keep probabilities 0.3 and 0.7.  Both auxiliary TD losses
# have weight 1.0 and resample the random mask at every timestep.
