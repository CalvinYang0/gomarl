...
SEEDS="${SEEDS:-1}"
MODELS="${MODELS:-rpg_public_private_bias_transformer_hypercond rpg_public_private_bias_transformer_topk_hypercond rpg_public_private_bias_transformer_threshold_hypercond rpg_global_public_private_bias_past_delta_token_transformer_hypercond rpg_global_public_private_bias_past_delta_token_transformer_topk_hypercond rpg_global_public_private_bias_past_delta_token_transformer_threshold_hypercond rpg_public_transformer_hypercond rpg_public_private_bias_transformer_hypercond rpg_public_private_bias_past_delta_token_transformer_hypercond}"
