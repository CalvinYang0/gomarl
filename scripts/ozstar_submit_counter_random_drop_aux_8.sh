...
# REFIL-inspired random-drop auxiliary ablation on GRF Counter:
#   drop probability {0.8, 0.5} x auxiliary weight {0.5, 1.0}
#   x sampling scope {episode-fixed, timestep-resampled}.
...
processed=0
for spec in \
  "80|0.20|05|0.5|episode" \
  "80|0.20|05|0.5|timestep" \
  "80|0.20|10|1.0|episode" \
  "80|0.20|10|1.0|timestep" \
  "50|0.50|05|0.5|episode" \
  "50|0.50|05|0.5|timestep" \
  "50|0.50|10|1.0|episode" \
...
echo "submitted total: $processed"
