...
export MODELS="${MODELS:-rpg_action_edge_rgcn_hypercond rpg_action_edge_egcn_hypercond rpg_action_edge_oracle_graph_hypercond rpg_action_edge_oracle_no_self_hypercond rpg_action_edge_coarse_private_fine_gate_hypercond}"
